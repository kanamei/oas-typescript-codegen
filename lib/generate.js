...
class Generator {
    ...
    generate(inputFile, outDir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const path of Object.keys(oas.paths)) {
                ...
                for (const method of this.methods) {
                    ...
                    if (requestBody && requestBody.schema) {
                        ...
                        const requestInterface = yield this.compileInterface(operation.operationId, 'RequestInput', requestParameters.schema);
                        imports.push(requestInterface.import);
                        exports.push(requestInterface.export);
                        requestParameterType = requestInterface.interfaceName;
                    }
            ...
            yield this.copy(pathUtil.join(__dirname, '../templates/tsconfig.json'), pathUtil.join(outDir, './tsconfig.json'));
            yield this.copy(pathUtil.join(__dirname, '../templates/gitignore'), pathUtil.join(outDir, './.gitignore'));
    ...
    extractRequestParameters(operation) {
        ...
        const properties = queries.reduce((prev, parameter) => {
            return Object.assign({}, prev, { [parameter.name]: parameter.schema });
        }, {});
        return {
            schema: {
                type: 'object',
